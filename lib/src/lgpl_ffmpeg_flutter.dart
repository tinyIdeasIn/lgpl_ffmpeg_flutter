...
class LgplFfmpegFlutter {
  ...
  /// Deletes PNG files generated by this plugin from the platform cache.
  static Future<int> deleteGeneratedFiles() {
    return LgplFfmpegFlutterPlatform.instance.deleteGeneratedFiles();
  }
}
